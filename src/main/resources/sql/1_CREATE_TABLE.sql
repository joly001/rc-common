...
(
   ...
   START_LONGITUDE		  DECIMAL(20,10) NOT NULL COMMENT '开始位置经度',
	 START_LATITUDE		    DECIMAL(20,7) NOT NULL COMMENT '开始位置纬度',
	 END_LONGITUDE		    DECIMAL(20,7) NOT NULL COMMENT '结束位置经度',
	 END_LATITUDE		      DECIMAL(20,7) NOT NULL COMMENT '结束位置纬度',
   CREATE_TIME          TIMESTAMP NULL COMMENT '创建时间',
   MODIFY_TIME          TIMESTAMP NULL COMMENT '修改时间',
   PRIMARY KEY (ID)
);
